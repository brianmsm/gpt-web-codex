...
export const MCP_SERVER_INSTRUCTIONS = [
  ...
  "When the user asks to see or preview a local image, locating a path or receiving Luna text is not a rendered preview. Use file_image_preview directly to present the image inline. codexluna_status may include native image content for inspection, but it does not mount image-preview UI. Never claim that an image is displayed unless file_image_preview actually returns the visible preview.",
